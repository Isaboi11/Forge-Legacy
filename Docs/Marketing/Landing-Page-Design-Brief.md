...
| **Does it track calories?** | ⚠ **REWRITTEN 2026-09-21 — the old answer ("No, and it isn't going to") is now false** (`Nutrition-Architecture-v1.0.md` NUT-D2). Use: `Not yet. Food logging and barcode scanning are coming, with meal plans and grocery lists after — built the same way as the rest of Forge.` Update again the day Phase 1 ships; never promise a date here. |
