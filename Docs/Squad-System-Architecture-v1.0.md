...
2. **Who can set or edit the active Goal:** any member, consistent with the existing Squad Identity model (S-3 §4.3 — squad identity belongs to the squad, not just the Owner). Last-write-wins on simultaneous edits, same as squad name/purpose.
