...
- Workout logging, programs, templates, chapters, goals, timeline, honors, accomplishments, squads — all free.
- **50 total stored photos.**
- Free tier never expires or degrades core functionality.

## Premium Tier

- **Unlimited photo storage.**
- Advanced features TBD at launch.
- Premium unlocks future capability. It never restricts past history.

## Storage Limits

**50 stored photos** is a cap on photos currently in the account — not a lifetime cap that decays.

A free user who has 50 photos always has those 50. They cannot add photo 51 without upgrading. Their 50 photos are never deleted.

## Photo Limits — Detailed Rules

| Scenario | Behavior |
|----------|---------|
| Free user attempts photo 51 | M-7 Premium Upsell Sheet fires |
| Free user upgrades then downgrades | All photos remain. No deletion. Cannot add new photos while over the free limit. |
| Premium user adds unlimited photos | All photos remain on downgrade — visible forever |
| Photo counter | Always shown on L-15: "X of 50 photos" (free) / "X photos" (premium) |

## Never Charge For History Principle

**History is never paywalled.**

- Archived chapter outcomes: always accessible, always free.
- Workout history: always accessible, always free.
- Timeline: always accessible, always free.
- Photos already stored: always visible, always free.
- Honors and accomplishments: always accessible, always free.

Premium unlocks future storage and future features. It does not restrict what the athlete has already built.
...
- 20 Workouts screens (8 activity types, programs, templates, logging, history, Workout With Friend)
...
**Total: ~76 MVP screens and states**
