...
/* ─────────────────────────────────────────────────────────────────────────────
   ⚠ THIS FILE IS THE SOURCE OF TRUTH FOR `src/constants/foundation.paper.ts`,
     AND IT IS NOT DEAD REFERENCE — `paper-tokens.test.mjs` PARSES IT.

   Exported verbatim from the Claude Design project "Forge Modal Library Design"
   (b029488a-201b-432f-b04c-b0df5228381e), where it drives the eight
   `* - Paper.dc.html` artboards. It is byte-identical to the token block in
   `Forge Legacy - Light Mode (Paper) - Claude Code Handoff.md`, which is what
   makes the spec trustworthy: two independently-written artefacts agree.

   Do not hand-edit. Re-export from the design project if the palette changes,
   and let the test tell you what drifted in the RN palette.
   ───────────────────────────────────────────────────────────────────────────── */
(function () {
var VARS = {
