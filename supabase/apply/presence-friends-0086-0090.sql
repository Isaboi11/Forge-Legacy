-- Forge Legacy — apply bundle: 0086 → 0090, IN ORDER.
--
-- NOT new migrations. All five are numbered in supabase/migrations/; this file exists so the whole chain
-- can be pasted in one go.
--
-- ORDER IS NOT OPTIONAL. 0087 adds `invited_ids`, which 0088 reads; 0089 reads `training_since` from
-- 0086; 0090 replaces a function 0085 created. Out of order fails with `42703` or `42P01`.
--
