-- ═════════════════════════════════════════════════════════════════════════════
-- PASTE BUNDLE — 0183. Paste this WHOLE FILE into the Supabase SQL editor at once.
...
--      supabase/migrations/0183_shared_route_consent.sql
-- ═════════════════════════════════════════════════════════════════════════════
...
begin
  ...
  if src is null then
    raise exception '0183 DID NOT APPLY. public.shared_workout_detail does not exist at all.';
  end if;
  ...
  if missing <> '' then
    raise exception '0183 DID NOT FULLY APPLY. Missing:%', missing;
  end if;

  raise notice '0183 OK — consent gate, route, climb_m, and the restored set duration_sec are all present.';
end $verify$;
