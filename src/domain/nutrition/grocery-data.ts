...
export const GROCERY: Record<string, GroceryItemMeta> = {
  ...
  low_carb_bagel: { name: "Low-carb bagels", aisle: "Pantry", buy: { kind: 'pack', grams: 276, unit: "pack of 6" }, staple: false, price: null },
  ...
  bbq_sauce: { name: "Reduced-calorie barbecue sauce", aisle: "Pantry", buy: { kind: 'pack', grams: 510, unit: "bottle" }, staple: false, price: null },
  ...
  burger_bun: { name: "Brioche burger buns", aisle: "Pantry", buy: { kind: 'pack', grams: 340, unit: "pack of 6" }, staple: false, price: null },
  ...
  low_carb_tortilla: { name: "Low-carb tortillas (large)", aisle: "Pantry", buy: { kind: 'pack', grams: 568, unit: "pack of 8" }, staple: false, price: null },
  mini_wrap: { name: "Low-carb mini wraps", aisle: "Pantry", buy: { kind: 'pack', grams: 280, unit: "pack of 10" }, staple: false, price: null },
