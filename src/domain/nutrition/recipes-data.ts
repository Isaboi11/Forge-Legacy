...
export const RECIPE_SOURCES: readonly RecipeSource[] = [
  {
    id: 'b01', slot: 'breakfast', name: "Greek yogurt bowl with granola and berries", minutes: 5, batch: false, equipment: [],
  ...
  {
    id: 'b02', slot: 'breakfast', name: "Steak and egg hash", minutes: 25, batch: false, equipment: [],
  ...
  {
    id: 'b03', slot: 'breakfast', name: "Peanut butter overnight oats", minutes: 5, batch: false, equipment: [],
  ...
  {
    id: 'b04', slot: 'breakfast', name: "Smoked salmon bagel", minutes: 10, batch: false, equipment: [],
  ...
  {
    id: 'b05', slot: 'breakfast', name: "Tofu scramble with black beans", minutes: 15, batch: false, equipment: [],
  ...
  {
    id: 'b06', slot: 'breakfast', name: "Protein pancakes with banana", minutes: 20, batch: false, equipment: [],
  ...
  {
    id: 'b07', slot: 'breakfast', name: "Turkey sausage breakfast burrito", minutes: 20, batch: false, equipment: [],
  ...
  {
    id: 'b08', slot: 'breakfast', name: "Shakshuka with feta and toast", minutes: 25, batch: false, equipment: [],
  ...
  {
    id: 'b09', slot: 'breakfast', name: "Cottage cheese and almond toast", minutes: 5, batch: false, equipment: [],
  ...
  {
    id: 'b10', slot: 'breakfast', name: "Chia pudding with mango", minutes: 5, batch: false, equipment: [],
  ...
  {
    id: 'l01', slot: 'lunch', name: "Chicken shawarma rice bowl", minutes: 30, batch: false, equipment: [],
  ...
  {
    id: 'l02', slot: 'lunch', name: "Tuna, white bean and rocket salad", minutes: 10, batch: false, equipment: [],
  ...
  {
    id: 'l03', slot: 'lunch', name: "Turkey and avocado wrap", minutes: 10, batch: false, equipment: [],
  ...
  {
    id: 'l04', slot: 'lunch', name: "Lentil and roasted vegetable soup", minutes: 40, batch: true, equipment: ["Sheet pan"],
  ...
  {
    id: 'l05', slot: 'lunch', name: "Chickpea and quinoa power bowl", minutes: 20, batch: false, equipment: [],
  ...
  {
    id: 'l06', slot: 'lunch', name: "Halloumi grain salad", minutes: 20, batch: false, equipment: [],
  ...
  {
    id: 'l07', slot: 'lunch', name: "Prawn noodle stir-fry", minutes: 20, batch: false, equipment: [],
  ...
  {
    id: 'l08', slot: 'lunch', name: "Beef burrito bowl", minutes: 25, batch: false, equipment: [],
  ...
  {
    id: 'l09', slot: 'lunch', name: "Egg fried rice with edamame", minutes: 15, batch: false, equipment: [],
  ...
  {
    id: 'l10', slot: 'lunch', name: "Mediterranean chicken pita", minutes: 15, batch: false, equipment: [],
  ...
  {
    id: 'd01', slot: 'dinner', name: "Salmon, sweet potato and greens", minutes: 30, batch: false, equipment: ["Sheet pan"],
  ...
  {
    id: 'd02', slot: 'dinner', name: "Beef chilli with rice", minutes: 45, batch: true, equipment: [],
  ...
  {
    id: 'd03', slot: 'dinner', name: "Chicken thigh tray bake", minutes: 40, batch: true, equipment: ["Sheet pan"],
  ...
  {
    id: 'd04', slot: 'dinner', name: "Turkey bolognese", minutes: 35, batch: true, equipment: [],
  ...
  {
    id: 'd05', slot: 'dinner', name: "Chickpea and spinach curry", minutes: 30, batch: true, equipment: [],
  ...
  {
    id: 'd06', slot: 'dinner', name: "Steak, potatoes and green beans", minutes: 30, batch: false, equipment: [],
  ...
  {
    id: 'd07', slot: 'dinner', name: "Cod with lemon orzo", minutes: 25, batch: false, equipment: [],
  ...
  {
    id: 'd08', slot: 'dinner', name: "Black bean tacos", minutes: 20, batch: false, equipment: [],
  ...
  {
    id: 'd09', slot: 'dinner', name: "Teriyaki tofu and broccoli rice", minutes: 25, batch: false, equipment: [],
  ...
  {
    id: 'd10', slot: 'dinner', name: "Pork tenderloin, rice and slaw", minutes: 35, batch: false, equipment: [],
  ...
  {
    id: 'd11', slot: 'dinner', name: "Mushroom and barley risotto", minutes: 45, batch: false, equipment: [],
  ...
  {
    id: 'd12', slot: 'dinner', name: "Chicken fajitas", minutes: 25, batch: true, equipment: [],
  ...
  {
    id: 's01', slot: 'snacks', name: "Apple and peanut butter", minutes: 3, batch: false, equipment: [],
  ...
  {
    id: 's02', slot: 'snacks', name: "Protein shake with banana", minutes: 3, batch: false, equipment: ["Blender"],
    ingredients: [['whey', 30], ['milk', 240], ['banana', 100]],
    steps: [{ title: "Blend", text: "Blend the milk, protein powder and banana until smooth." }],
  },
  {
    id: 's03', slot: 'snacks', name: "Hummus and pitta", minutes: 3, batch: false, equipment: [],
  ...
  {
    id: 's04', slot: 'snacks', name: "Trail mix", minutes: 1, batch: false, equipment: [],
    ingredients: [['almonds', 25], ['peanuts', 20], ['raisins', 20]],
    steps: [{ title: "Mix", text: "Mix the almonds, peanuts and raisins." }],
  },
  {
    id: 's05', slot: 'snacks', name: "Boiled eggs and fruit", minutes: 12, batch: false, equipment: [],
  ...
  {
    id: 's06', slot: 'snacks', name: "Edamame with sea salt", minutes: 5, batch: false, equipment: [],
  ...
  {
    id: 's07', slot: 'snacks', name: "Rice cakes with cottage cheese", minutes: 3, batch: false, equipment: [],
  ...
  {
    id: 's08', slot: 'snacks', name: "Beef jerky and an orange", minutes: 1, batch: false, equipment: [],
