...
export const SCREEN_TOURS: Record<ScreenTourKey, readonly ScreenTourStep[]> = {
  ...
  'day-builder': [
    ...
    },
    {
      ...
      body: 'A cardio block is measured in distance, time and pace rather than sets and reps — set any of them, leave the rest open. What appears depends on the activity: a stair climber counts floors instead of distance, a swim has no pace, and a swim is measured in yards.',
      anchor: 'day-cardio',
      pad: 8,
      radius: 14,
    },
