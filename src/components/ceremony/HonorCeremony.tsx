              ...
              <Svg width="100%" height="100%">
                <Defs>
                  <RadialGradient id="honor-bloom" cx="50%" cy="50%" rx="50%" ry="50%">
                    <Stop offset="0" stopColor="rgba(191,143,79,0.38)" />
                    <Stop offset="0.46" stopColor="rgba(191,143,79,0.09)" />
                    <Stop offset="0.7" stopColor="rgba(191,143,79,0)" />
                  </RadialGradient>
                </Defs>
                  ...
                  <Svg width="100%" height="100%">
                    <Defs>
                      <RadialGradient id="honor-sym" cx="50%" cy="60%" rx="50%" ry="50%">
                        <Stop offset="0" stopColor="rgba(205,160,99,0.55)" />
                        <Stop offset="0.45" stopColor="rgba(191,143,79,0.16)" />
                        <Stop offset="0.72" stopColor="rgba(191,143,79,0)" />
                      </RadialGradient>
                    </Defs>
