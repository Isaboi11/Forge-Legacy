...
export default function SquadPreviewScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={[themeScrim('rgba(9,9,9,0.55)'), themeScrim('rgba(9,9,9,0.86)')]} start={{ x: 0.5, y: 0 }} end={{ x: 0.5, y: 1 }} style={[styles.commitBar, { paddingBottom: 16 + insets.bottom }]}>
        <Pressable
