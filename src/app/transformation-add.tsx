...
const styles = StyleSheet.create({
  ...
  slotEmpty: { borderWidth: 1, borderColor: flColor.bronzeBorder, backgroundColor: 'rgba(191,143,79,0.06)', ...DASH },
  ...
  videoEmpty: { borderWidth: 1, borderColor: flColor.bronzeBorder, backgroundColor: 'rgba(191,143,79,0.06)', ...DASH },
