...
- [x] **Nutrition Phase 1 (tracking)** — ◐ BUILT, NOT SHIPPED (2026-09-22): tab + Nutrition Home + Log Food + manual targets; `0205` authored not applied; `food-search` not deployed; barcode typed until the next binary.
