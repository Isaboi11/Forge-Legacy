...
- [x] **Apple Watch: PHASE 1 SHIPPED AND ON A REAL WRIST (2026-09-02)** — `Docs/Apple-Watch-Companion-Build-Plan.md`, DQ #29. The
      companion rides inside build 8 and the PO installed it: app on the watch, watchOS 10.6, **colours correct**.
      Phase 2 (the WatchConnectivity bridge to a live session) is NOT built — the watch shows only the Idle card
