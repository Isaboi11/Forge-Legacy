...
### 0. ⭐ Five of the seven cardio activities could not be found at all — and every machine was offered a road (2026-08-24, Exercise Picker / Conditioning / both Builders — **no migration**, ✅ **WEB DEPLOYED**, ⏳ **NOT OTA'd**)
...
✅ **WEB DEPLOYED AND VERIFIED** — `entry-a1eabe43da69d8e09241a0b2db6a45c2.js`, prod **200** on the first check (no alias fault this time), live bundle **MD5-identical** to `dist/`, and six strings only this code contains found in the **LIVE** bundle. Commit `3848650`. ⏳ **NOT OTA'd to the phone** — JS-only and OTA-safe, simply not published.

### 0. ⭐ The goal form now says what a goal can be — and what its number means (2026-08-24, G-3 Goal Create/Edit — **no migration**, ✅ **WEB DEPLOYED**, ⏳ **NOT OTA'd**)
...
✅ **WEB DEPLOYED AND VERIFIED** — `entry-0a48500ea73c7f347b2e3b1b4b97bf04.js`, prod **200**, live bundle **MD5-identical** to `dist/`, and three strings only this code contains found in the **LIVE** bundle. Commit `13b3a4c` on `feat/route-map`. ⏳ **NOT OTA'd to the phone** — JS-only and OTA-safe, simply not published.
...
The **53** entries before this point moved there on 2026-08-18, 2026-08-19, 2026-08-20, 2026-08-22 and 2026-08-24 (four times), **verbatim**. Nothing was deleted or
summarised.
