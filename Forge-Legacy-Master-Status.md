...
### 0. A set leaves the table from its own row — the Remove Set pill is gone (2026-08-27, Active Workout — **no migration**, ⏳ **NOT DEPLOYED** — commit `49a97ab`)
...
**Gates:** tsc 0 · **2,908/2,908** · lint at baseline. ⏳ **Not deployed and not seen rendered:** a second session had `app.json` / `package.json` / `targets/` mid-edit in the same tree (`@bacons/apple-targets`, the Apple Watch companion), and a publish bundles the working tree. Deploy with the next clean pass.
