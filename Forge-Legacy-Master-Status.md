...
⏳ NEXT: the run-card composer (photo / map / photo+map formats, D-RS-3 consent plumbing, shared-detail
map), the squad composer's chooser, a NEW iOS BUILD. Gates: tsc 0 · lint clean · **2,877/2,877** (+12).
