...
### 0. The weigh-in sheet lays out on a phone, drops the "no goal" line, moves the weight goal — and the Legacy bar measures from the baseline (2026-08-28, Progress Hub / Body Metrics / Goals / Legacy — **no migration**, ✅ **WEB DEPLOYED** `index-cdd6c6e100161c4160d70c7a69f4d41d` · ✅ **OTAs PUBLISHED TO BUILD 7** iOS `01a04914…` + `01a04940-def7-7d01-995c-0a48929b8d75`, runtime `4d728d16…` — commits `32ee348` `c4eeba6`)
