...
| **Testing** | 🟢 | **2,751 green** (`node --test`, measured 2026-08-22) + live Supabase round-trip proofs; gates every unit. Coverage % still not instrumented → not measured |
...
The 44 entries before this point moved there on 2026-08-18, 2026-08-19, 2026-08-20 and 2026-08-22, **verbatim**. Nothing was deleted or
summarised.
